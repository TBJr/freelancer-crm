                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <table class="table-auto w-full border-collapse border border-gray-200 dark:border-gray-700">
                        ...
                        <tr>
                            ...
                            <th class="border border-gray-200 dark:border-gray-700 px-4 py-2">Email</th>
                            <th class="border border-gray-200 dark:border-gray-700 px-4 py-2">Phone</th>
                        ...
                        @foreach ($customers as $customer)
                            <tr>
                                <td class="border border-gray-200 dark:border-gray-700 px-4 py-2">{{ $customer->name }}</td>
                                <td class="border border-gray-200 dark:border-gray-700 px-4 py-2">{{ $customer->email }}</td>
                                <td class="border border-gray-200 dark:border-gray-700 px-4 py-2">{{ $customer->phone }}</td>
